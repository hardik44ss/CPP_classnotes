...
public:
    ...
    void getOption() {
        ...
        string opt="1. \033[1;36mIntroduction\033[0m\n2. \033[1;36mSkill Set\033[0m\n3. \033[1;36mInterpersonal\033[0m\n4. \033[1;36mEducation\033[0m\n5. \033[1;36mProject\033[0m\n. \033[1;31m-Exit\033[0m\n\n";
        for(char c : opt){
            cout<<c;
            Sleep(20);
        }
    ...
    void showCV(int choice) {
        ...
        case 2: {
            ...
            case 1:
                ...
                break;
            case 2: {
                cout << "\033[1;32m\n\nDuring my academic journey, I developed into the realm of programming, specifically focusing on C++. Equipped with a strong foundation in the language, I successfully applied my knowledge to various projects and coursework. Proficient in using Visual Studio for programming purposes, I have honed my skills in C++ to a level where I am confidently navigating the intricacies of the language. .\033[0m";
                askHelp();
                break;
            }
            break;
            case 3: {
                cout << "\033[1;32m\n\nIn my academic journey, I have been introduced to the fundamental concepts of web development, particularly in HTML and CSS. While I haven't delved deeply into these technologies yet, I possess a foundational understanding of their principles. HTML serves as the backbone for structuring web content, allowing me to create and organize various elements on a webpage. Additionally, I have explored CSS to style and visually enhance the presentation of HTML elements.skills.\033[0m";
                askHelp();
                break;
            }
            case 4:
